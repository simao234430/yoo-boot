package com.yoo.boot.common.system.query;
...
import com.yoo.boot.common.system.vo.SysPermissionDataRuleModel;
import com.yoo.boot.common.util.CommonUtils;
import com.yoo.boot.common.util.DateUtils;
import com.yoo.boot.common.util.SqlInjectionUtil;
...
public class QueryGenerator {
	...
	public static Map<String, SysPermissionDataRuleModel> getRuleMap() {
		...
		List<SysPermissionDataRuleModel> list = YooDataAutorUtils.loadDataSearchConditon();
	...
	public static Map<String, SysPermissionDataRuleModel> getRuleMap(List<SysPermissionDataRuleModel> list) {
		Map<String, SysPermissionDataRuleModel> ruleMap = new HashMap<String, SysPermissionDataRuleModel>();
		if(list==null){
			list = YooDataAutorUtils.loadDataSearchConditon();
		}
		if(list != null&&list.size()>0){
			if(list.get(0)==null){
				return ruleMap;
