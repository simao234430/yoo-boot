...
import com.yoo.boot.common.constant.CacheConstant;
...
import com.yoo.boot.modules.system.mapper.SysPermissionMapper;
import com.yoo.boot.modules.system.mapper.SysRolePermissionMapper;
...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
	...
	public void deletePermission(String id) throws YooBootException {
		...
		if(sysPermission==null) {
			throw new YooBootException("未找到菜单信息");
		}
